    ...
    <main className="flex flex-col w-full overflow-hidden">
      ...
      <section className="relative w-full h-screen flex items-center justify-center overflow-hidden bg-gray-100">
        <div
          ...
          style={{
            backgroundImage: "url('https://images.unsplash.com/photo-1582793988951-9aed550c6918?q=80&w=2000&auto=format&fit=crop')",
            backgroundSize: 'cover',
            backgroundPosition: 'center',
          }}
        ></div>

        <div className="absolute inset-0 bg-primary bg-opacity-40 mix-blend-multiply"></div>
        {/* コントラストを保つための薄いグラデーション */}
        <div className="absolute inset-0 bg-gradient-to-b from-black/10 to-black/30"></div>

        <div className="relative z-10 flex flex-col items-center justify-center text-white animate-fade-in-up mt-16 drop-shadow-md">
      ...
      <section id="news" className="px-6 py-24 max-w-4xl mx-auto w-full scroll-mt-20">
        ...
        <ul className="divide-y divide-gray-200 border-t border-b border-gray-200">
          <li className="py-6 flex flex-col md:flex-row md:items-center gap-4 group cursor-pointer">
            ...
            <div className="font-bold group-hover:text-primary transition-colors">コーポレートサイト（ベータ版）を公開しました</div>
          </li>
          <li className="py-6 flex flex-col md:flex-row md:items-center gap-4 group cursor-pointer">
            <div className="text-gray-500 text-sm font-sans w-32 shrink-0">2026.08.15</div>
            <div className="font-bold group-hover:text-primary transition-colors">日本茶ミルクティー専門店「けのちゃ」東神田店オープンのお知らせ</div>
          </li>
        </ul>
      </section>
